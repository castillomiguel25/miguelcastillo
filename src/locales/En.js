export default {
  message: {
    greeting: 'Hello, I am',
    presentation: 'My portfolio is a reflection of my journey in the web development realm, and I would love to share it with you.',
    project: 'Projects',
    Recientes: 'Recent',
    Contact: 'Contact me',
    ...
    Arkanoid: 'Making the famous Arkanoid game following Midudev 100 Projects in JavaScript classes.',
    Zodiaco:'Game made in a practical JavaScript workshop in Platzi',
    skills: 'skills',
